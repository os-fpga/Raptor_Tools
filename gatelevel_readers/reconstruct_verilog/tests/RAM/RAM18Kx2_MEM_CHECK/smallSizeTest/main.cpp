...
int main() {
  ...
  // Generate and save the random strings
  std::string init1_p = random_string(4 * 4);
  std::string init1 = random_string(4 * 32);
  std::string init2_p = random_string(4 * 4);
  std::string init2 = random_string(4 * 32);

  std::string initMem = get_init_i1(init1, init1_p, init2, init2_p);
  std::string initMem_h = "   localparam [288-1:0] INIT_i1_cpp = 288'h" +
                          stringEncode(initMem) + ";";
  std::string init1_p_h =
      "   parameter [16-1:0] INIT1_PARITY = 16'h" + stringEncode(init1_p) + ";";
  std::string init1_h =
      "   parameter [144-1:0] INIT1 =  144'h" + stringEncode(init1) + ";";
  std::string init2_p_h =
      "   parameter [16-1:0] INIT2_PARITY = 16'h" + stringEncode(init2_p) + ";";
  std::string init2_h =
      "   parameter [144-1:0] INIT2 = 144'h" + stringEncode(init2) + ";";
