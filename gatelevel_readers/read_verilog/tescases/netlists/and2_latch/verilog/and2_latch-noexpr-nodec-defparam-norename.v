...
module and2_latch(a, b, clk, c, d);
  ...
  dffsre \$abc$194$auto$blifparse.cc:362:parse_blif$195  (
    .C(clk),
    .D(c),
    .E(1'h1),
    .Q(d),
  ...
  \$lut  \$abc$346$auto$blifparse.cc:515:parse_blif$347  (
    .A({ b, a, 1'h0 }),
    .Y(c)
  );
  defparam \$abc$346$auto$blifparse.cc:515:parse_blif$347 .LUT = 8'hca;
  defparam \$abc$346$auto$blifparse.cc:515:parse_blif$347 .WIDTH = 32'h00000003;
endmodule
