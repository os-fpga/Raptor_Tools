...
module adder_64(cout, sum, a, b, cin);
  ...
  defparam _072_.WIDTH = 32'd1;
  \$lut  _073_ (
    .A({ b[21], _069_, a[21] }),
    .Y(_071_[21])
  );
  defparam _073_.LUT = 8'hca;
  defparam _073_.WIDTH = 32'd3;
  \$lut  _074_ (
    .A(a[22]),
    .Y(_004_)
  );
  defparam _074_.LUT = 2'h1;
  defparam _074_.WIDTH = 32'd1;
  \$lut  _075_ (
    .A({ b[22], _004_, a[22] }),
    .Y(_071_[22])
  );
  defparam _075_.LUT = 8'hca;
  defparam _075_.WIDTH = 32'd3;
  \$lut  _076_ (
    .A(a[23]),
    .Y(_005_)
  );
  defparam _076_.LUT = 2'h1;
  defparam _076_.WIDTH = 32'd1;
  \$lut  _077_ (
    .A({ b[23], _005_, a[23] }),
    .Y(_071_[23])
  );
  defparam _077_.LUT = 8'hca;
  defparam _077_.WIDTH = 32'd3;
  \$lut  _078_ (
    .A(a[24]),
    .Y(_006_)
  );
  defparam _078_.LUT = 2'h1;
  defparam _078_.WIDTH = 32'd1;
  \$lut  _079_ (
    .A({ b[24], _006_, a[24] }),
    .Y(_071_[24])
  );
  defparam _079_.LUT = 8'hca;
  defparam _079_.WIDTH = 32'd3;
  \$lut  _080_ (
    .A(a[25]),
    .Y(_007_)
  );
  defparam _080_.LUT = 2'h1;
  defparam _080_.WIDTH = 32'd1;
  \$lut  _081_ (
    .A({ b[25], _007_, a[25] }),
    .Y(_071_[25])
  );
  defparam _081_.LUT = 8'hca;
  defparam _081_.WIDTH = 32'd3;
  \$lut  _082_ (
    .A(a[26]),
    .Y(_008_)
  );
  defparam _082_.LUT = 2'h1;
  defparam _082_.WIDTH = 32'd1;
  \$lut  _083_ (
    .A({ b[26], _008_, a[26] }),
    .Y(_071_[26])
  );
  defparam _083_.LUT = 8'hca;
  defparam _083_.WIDTH = 32'd3;
  \$lut  _084_ (
    .A(a[27]),
    .Y(_009_)
  );
  defparam _084_.LUT = 2'h1;
  defparam _084_.WIDTH = 32'd1;
  \$lut  _085_ (
    .A({ b[27], _009_, a[27] }),
    .Y(_071_[27])
  );
  defparam _085_.LUT = 8'hca;
  defparam _085_.WIDTH = 32'd3;
  \$lut  _086_ (
    .A(a[28]),
    .Y(_010_)
  );
  defparam _086_.LUT = 2'h1;
  defparam _086_.WIDTH = 32'd1;
  \$lut  _087_ (
    .A({ b[28], _010_, a[28] }),
    .Y(_071_[28])
  );
  defparam _087_.LUT = 8'hca;
  defparam _087_.WIDTH = 32'd3;
  \$lut  _088_ (
    .A(a[29]),
    .Y(_011_)
  );
  defparam _088_.LUT = 2'h1;
  defparam _088_.WIDTH = 32'd1;
  \$lut  _089_ (
    .A({ b[29], _011_, a[29] }),
    .Y(_071_[29])
  );
  defparam _089_.LUT = 8'hca;
  defparam _089_.WIDTH = 32'd3;
  \$lut  _090_ (
    .A(a[30]),
    .Y(_012_)
  );
  defparam _090_.LUT = 2'h1;
  defparam _090_.WIDTH = 32'd1;
  \$lut  _091_ (
    .A({ b[30], _012_, a[30] }),
    .Y(_071_[30])
  );
  defparam _091_.LUT = 8'hca;
  defparam _091_.WIDTH = 32'd3;
  \$lut  _092_ (
    .A(a[31]),
    .Y(_013_)
  );
  defparam _092_.LUT = 2'h1;
  defparam _092_.WIDTH = 32'd1;
  \$lut  _093_ (
    .A({ b[31], _013_, a[31] }),
    .Y(_071_[31])
  );
  defparam _093_.LUT = 8'hca;
  defparam _093_.WIDTH = 32'd3;
  \$lut  _094_ (
    .A(a[32]),
    .Y(_014_)
  );
  defparam _094_.LUT = 2'h1;
  defparam _094_.WIDTH = 32'd1;
  \$lut  _095_ (
    .A({ b[32], _014_, a[32] }),
    .Y(_071_[32])
  );
  defparam _095_.LUT = 8'hca;
  defparam _095_.WIDTH = 32'd3;
  \$lut  _096_ (
    .A(a[33]),
    .Y(_015_)
  );
  defparam _096_.LUT = 2'h1;
  defparam _096_.WIDTH = 32'd1;
  \$lut  _097_ (
    .A({ b[33], _015_, a[33] }),
    .Y(_071_[33])
  );
  defparam _097_.LUT = 8'hca;
  defparam _097_.WIDTH = 32'd3;
  \$lut  _098_ (
    .A(a[34]),
    .Y(_016_)
  );
  defparam _098_.LUT = 2'h1;
  defparam _098_.WIDTH = 32'd1;
  \$lut  _099_ (
    .A({ b[34], _016_, a[34] }),
    .Y(_071_[34])
  );
  defparam _099_.LUT = 8'hca;
  defparam _099_.WIDTH = 32'd3;
  \$lut  _100_ (
    .A(a[35]),
    .Y(_017_)
  );
  defparam _100_.LUT = 2'h1;
  defparam _100_.WIDTH = 32'd1;
  \$lut  _101_ (
    .A({ b[35], _017_, a[35] }),
    .Y(_071_[35])
  );
  defparam _101_.LUT = 8'hca;
  defparam _101_.WIDTH = 32'd3;
  \$lut  _102_ (
    .A(a[36]),
    .Y(_018_)
  );
  defparam _102_.LUT = 2'h1;
  defparam _102_.WIDTH = 32'd1;
  \$lut  _103_ (
    .A({ b[36], _018_, a[36] }),
    .Y(_071_[36])
  );
  defparam _103_.LUT = 8'hca;
  defparam _103_.WIDTH = 32'd3;
  \$lut  _104_ (
    .A(a[37]),
    .Y(_019_)
  );
  defparam _104_.LUT = 2'h1;
  defparam _104_.WIDTH = 32'd1;
  \$lut  _105_ (
    .A({ b[37], _019_, a[37] }),
    .Y(_071_[37])
  );
  defparam _105_.LUT = 8'hca;
  defparam _105_.WIDTH = 32'd3;
  \$lut  _106_ (
    .A(a[38]),
    .Y(_020_)
  );
  defparam _106_.LUT = 2'h1;
  defparam _106_.WIDTH = 32'd1;
  \$lut  _107_ (
    .A({ b[38], _020_, a[38] }),
    .Y(_071_[38])
  );
  defparam _107_.LUT = 8'hca;
  defparam _107_.WIDTH = 32'd3;
  \$lut  _108_ (
    .A(a[39]),
    .Y(_021_)
  );
  defparam _108_.LUT = 2'h1;
  defparam _108_.WIDTH = 32'd1;
  \$lut  _109_ (
    .A({ b[39], _021_, a[39] }),
    .Y(_071_[39])
  );
  defparam _109_.LUT = 8'hca;
  defparam _109_.WIDTH = 32'd3;
  \$lut  _110_ (
    .A(a[40]),
    .Y(_022_)
  );
  defparam _110_.LUT = 2'h1;
  defparam _110_.WIDTH = 32'd1;
  \$lut  _111_ (
    .A({ b[40], _022_, a[40] }),
    .Y(_071_[40])
  );
  defparam _111_.LUT = 8'hca;
  defparam _111_.WIDTH = 32'd3;
  \$lut  _112_ (
    .A(a[41]),
    .Y(_023_)
  );
  defparam _112_.LUT = 2'h1;
  defparam _112_.WIDTH = 32'd1;
  \$lut  _113_ (
    .A({ b[41], _023_, a[41] }),
    .Y(_071_[41])
  );
  defparam _113_.LUT = 8'hca;
  defparam _113_.WIDTH = 32'd3;
  \$lut  _114_ (
    .A(a[42]),
    .Y(_024_)
  );
  defparam _114_.LUT = 2'h1;
  defparam _114_.WIDTH = 32'd1;
  \$lut  _115_ (
    .A({ b[42], _024_, a[42] }),
    .Y(_071_[42])
  );
  defparam _115_.LUT = 8'hca;
  defparam _115_.WIDTH = 32'd3;
  \$lut  _116_ (
    .A(a[43]),
    .Y(_025_)
  );
  defparam _116_.LUT = 2'h1;
  defparam _116_.WIDTH = 32'd1;
  \$lut  _117_ (
    .A({ b[43], _025_, a[43] }),
    .Y(_071_[43])
  );
  defparam _117_.LUT = 8'hca;
  defparam _117_.WIDTH = 32'd3;
  \$lut  _118_ (
    .A(a[44]),
    .Y(_026_)
  );
  defparam _118_.LUT = 2'h1;
  defparam _118_.WIDTH = 32'd1;
  \$lut  _119_ (
    .A({ b[44], _026_, a[44] }),
    .Y(_071_[44])
  );
  defparam _119_.LUT = 8'hca;
  defparam _119_.WIDTH = 32'd3;
  \$lut  _120_ (
    .A(a[45]),
    .Y(_027_)
  );
  defparam _120_.LUT = 2'h1;
  defparam _120_.WIDTH = 32'd1;
  \$lut  _121_ (
    .A({ b[45], _027_, a[45] }),
    .Y(_071_[45])
  );
  defparam _121_.LUT = 8'hca;
  defparam _121_.WIDTH = 32'd3;
  \$lut  _122_ (
    .A(a[46]),
    .Y(_028_)
  );
  defparam _122_.LUT = 2'h1;
  defparam _122_.WIDTH = 32'd1;
  \$lut  _123_ (
    .A({ b[46], _028_, a[46] }),
    .Y(_071_[46])
  );
  defparam _123_.LUT = 8'hca;
  defparam _123_.WIDTH = 32'd3;
  \$lut  _124_ (
    .A(a[47]),
    .Y(_029_)
  );
  defparam _124_.LUT = 2'h1;
  defparam _124_.WIDTH = 32'd1;
  \$lut  _125_ (
    .A({ b[47], _029_, a[47] }),
    .Y(_071_[47])
  );
  defparam _125_.LUT = 8'hca;
  defparam _125_.WIDTH = 32'd3;
  \$lut  _126_ (
    .A(a[48]),
    .Y(_030_)
  );
  defparam _126_.LUT = 2'h1;
  defparam _126_.WIDTH = 32'd1;
  \$lut  _127_ (
    .A({ b[48], _030_, a[48] }),
    .Y(_071_[48])
  );
  defparam _127_.LUT = 8'hca;
  defparam _127_.WIDTH = 32'd3;
  \$lut  _128_ (
    .A(a[49]),
    .Y(_031_)
  );
  defparam _128_.LUT = 2'h1;
  defparam _128_.WIDTH = 32'd1;
  \$lut  _129_ (
    .A({ b[49], _031_, a[49] }),
    .Y(_071_[49])
  );
  defparam _129_.LUT = 8'hca;
  defparam _129_.WIDTH = 32'd3;
  \$lut  _130_ (
    .A(a[50]),
    .Y(_032_)
  );
  defparam _130_.LUT = 2'h1;
  defparam _130_.WIDTH = 32'd1;
  \$lut  _131_ (
    .A({ b[50], _032_, a[50] }),
    .Y(_071_[50])
  );
  defparam _131_.LUT = 8'hca;
  defparam _131_.WIDTH = 32'd3;
  \$lut  _132_ (
    .A(a[51]),
    .Y(_033_)
  );
  defparam _132_.LUT = 2'h1;
  defparam _132_.WIDTH = 32'd1;
  \$lut  _133_ (
    .A({ b[51], _033_, a[51] }),
    .Y(_071_[51])
  );
  defparam _133_.LUT = 8'hca;
  defparam _133_.WIDTH = 32'd3;
  \$lut  _134_ (
    .A(a[52]),
    .Y(_034_)
  );
  defparam _134_.LUT = 2'h1;
  defparam _134_.WIDTH = 32'd1;
  \$lut  _135_ (
    .A({ b[52], _034_, a[52] }),
    .Y(_071_[52])
  );
  defparam _135_.LUT = 8'hca;
  defparam _135_.WIDTH = 32'd3;
  \$lut  _136_ (
    .A(a[53]),
    .Y(_035_)
  );
  ...
  defparam _158_.WIDTH = 32'd3;
  \$lut  _159_ (
    .A(_000_),
    .Y(_046_)
  );
  defparam _159_.LUT = 2'h1;
  defparam _159_.WIDTH = 32'd1;
  \$lut  _160_ (
    .A({ _002_, _046_, 1'h1 }),
    .Y(_003_)
  );
  defparam _160_.LUT = 8'hca;
  defparam _160_.WIDTH = 32'd3;
  \$lut  _161_ (
    .A(_001_),
    .Y(_047_)
  );
  defparam _161_.LUT = 2'h1;
  defparam _161_.WIDTH = 32'd1;
  \$lut  _162_ (
    .A({ _003_, _047_, 1'h1 }),
    .Y(cout)
  );
  defparam _162_.LUT = 8'hca;
  defparam _162_.WIDTH = 32'd3;
  \$lut  _163_ (
    .A({ _002_, _046_, _000_ }),
    .Y(sum[63])
  );
