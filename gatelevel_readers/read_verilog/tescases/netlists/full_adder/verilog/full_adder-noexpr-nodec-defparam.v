...
module full_adder(a, b, cin, sum, cout);
  ...
  defparam _08_.WIDTH = 32'h00000003;
  \$lut  _09_ (
    .A(a),
    .Y(_05_)
  );
  defparam _09_.LUT = 2'h1;
  defparam _09_.WIDTH = 32'h00000001;
  \$lut  _10_ (
    .A({ b, _05_, 1'h1 }),
    .Y(_01_)
  );
  defparam _10_.LUT = 8'hca;
  defparam _10_.WIDTH = 32'h00000003;
  \$lut  _11_ (
    .A({ _02_, 1'h1, cin }),
    .Y(_03_)
  );
  defparam _11_.LUT = 8'hca;
  defparam _11_.WIDTH = 32'h00000003;
  \$lut  _12_ (
    .A({ _01_, _04_, cin }),
    .Y(_00_)
  );
  defparam _12_.LUT = 8'hca;
  defparam _12_.WIDTH = 32'h00000003;
  \$lut  _13_ (
    .A({ _00_, _03_, 1'h0 }),
    .Y(sum)
  );
  defparam _13_.LUT = 8'hca;
  defparam _13_.WIDTH = 32'h00000003;
  \$lut  _14_ (
    .A(_01_),
    .Y(_06_)
  );
  defparam _14_.LUT = 2'h1;
  defparam _14_.WIDTH = 32'h00000001;
  \$lut  _15_ (
    .A({ _02_, _07_, 1'h1 }),
    .Y(_04_)
  );
  defparam _15_.LUT = 8'hca;
  defparam _15_.WIDTH = 32'h00000003;
  \$lut  _16_ (
    .A({ _04_, _06_, 1'h1 }),
    .Y(cout)
  );
  defparam _16_.LUT = 8'hca;
  defparam _16_.WIDTH = 32'h00000003;
  \$lut  _17_ (
    .A(cin),
    .Y(_07_)
  );
  defparam _17_.LUT = 2'h1;
  defparam _17_.WIDTH = 32'h00000001;
endmodule
