...
./pin_map -io ../Test_cases/primitive_example_design_4/post_synth_ports.json -i ../Test_cases/primitive_example_design_4/interface.json -j ../b1/pin_map.json -t ../Test_cases/Gemini_Pin_Table.csv -o primitive_example_design_4.pin